...
func nemesisAllowedForWorkload(workload, nemesis string) bool {
	allowed := map[string]map[string]struct{}{
		...
		"append-reinit":             {"reinit-replica": {}, "reinit-replica-kill-target": {}, "reinit-replica-kill-source": {}, "reinit-replica-dcs-partition-target": {}, "reinit-replica-dcs-partition-primary": {}, "reinit-replica-concurrent-request": {}, "reinit-replica-after-failover": {}},
