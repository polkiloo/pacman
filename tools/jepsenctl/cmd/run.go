...
func dockerCampaignEnv(repoRoot, campaign, caseName string) map[string]string {
	return map[string]string{
		...
		"PACMAN_JEPSEN_OLD_PRIMARY_REJOIN_TIMEOUT_SECONDS":   os.Getenv("PACMAN_JEPSEN_OLD_PRIMARY_REJOIN_TIMEOUT_SECONDS"),
		"PACMAN_JEPSEN_OLD_PRIMARY_REJOIN_INTERVAL_SECONDS":  os.Getenv("PACMAN_JEPSEN_OLD_PRIMARY_REJOIN_INTERVAL_SECONDS"),
...
func dockerEnvArgs(env map[string]string) []string {
	keys := []string{
		...
		"PACMAN_JEPSEN_OLD_PRIMARY_REJOIN_TIMEOUT_SECONDS",
		"PACMAN_JEPSEN_OLD_PRIMARY_REJOIN_INTERVAL_SECONDS",
