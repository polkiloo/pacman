...
var (
	...
	ErrReinitWALGConfigRequired             = errors.New("config reinit walg is required")
	ErrReinitWALGBinaryRequired             = errors.New("config reinit walg binary is required")
	...
	ErrReinitWALGCredentialSourceConflict   = errors.New("config reinit walg credentials define the same environment variable multiple times")
