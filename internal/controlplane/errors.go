...
var (
	...
	ErrRejoinExecutionRequired              = errors.New("rejoin continuation requires an active rejoin operation")
	ErrRejoinExecutionChanged               = errors.New("rejoin execution changed during continuation")
	ErrRejoinRewindExecutorRequired         = errors.New("rejoin rewind requires a rewind executor")
	ErrRejoinStandbyConfigExecutorRequired  = errors.New("rejoin standby configuration requires a configuration executor")
	ErrRejoinStandbyRestartExecutorRequired = errors.New("rejoin standby restart requires a restart executor")
	ErrRejoinStandbyConfigurationRequired   = errors.New("rejoin standby restart requires rendered standby configuration")
	ErrRejoinCurrentPrimaryAddressRequired  = errors.New("rejoin standby configuration requires a current primary postgres address")
	ErrRejoinReplicationNotHealthy          = errors.New("rejoin replication is not healthy yet")
	...
	ErrReinitObservedStateRequired          = errors.New("reinit validation requires observed cluster state")
	ErrReinitTargetRequired                 = errors.New("reinit member is required")
	ErrReinitTargetUnknown                  = errors.New("reinit member is not present in observed state")
	ErrReinitTargetIsCurrentPrimary         = errors.New("reinit target member is already the current primary")
	ErrReinitTargetIsWitness                = errors.New("reinit target member is a witness")
	ErrReinitSourcePrimaryUnknown           = errors.New("reinit cannot proceed without a current primary")
	ErrReinitSourcePrimaryUnhealthy         = errors.New("reinit requires a healthy current primary")
	ErrReinitOperationInProgress            = errors.New("reinit is blocked while another cluster operation is active")
	ErrReinitExecutionRequired              = errors.New("reinit execution requires an active reinit operation")
	ErrReinitExecutionChanged               = errors.New("reinit execution changed during continuation")
	...
	ErrReinitReplicationVerifierRequired    = errors.New("reinit replication verification requires a verifier")
	...
	ErrReinitReplicationNotHealthy          = errors.New("reinit replication is not healthy yet")
