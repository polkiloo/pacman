...
var (
	...
	ErrReinitStateRequired             = errors.New("reinit state is required")
	ErrReinitUpdatedAtRequired         = errors.New("reinit updated time is required")
	...
	ErrInvalidReinitState              = errors.New("reinit state is invalid")
