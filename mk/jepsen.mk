...
jepsen-nightly-post:
ifeq ($(PACMAN_JEPSEN_BUILD_RPM),true)
	$(MAKE) rpm RPM_OUTPUT_DIR=$(PACMAN_ANSIBLE_INSTALL_RPM_DIR)
endif
	$(JEPSEN_CI_SCRIPT) nightly-post
